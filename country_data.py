countries = [
    ...
    {"name": "Burundi", "capital": "Gitega (political), Buhumbura (economic)"},
    ...
    {"name": "Eswatini", "capital": "Mbabane (executive), Lobamba (legislative)"},
    ...
    {"name": "Georgia (country)", "capital": "Tbilisi"},
    ...
    {
        "name": "Indonesia",
        "capital": "Jakarta (current), Nusantara (under construction)",
    },
    {"name": "Iran", "capital": "Tehran"},
    {"name": "Iraq", "capital": "Baghdad"},
    {"name": "Republic of Ireland", "capital": "Dublin"},
    {"name": "Israel", "capital": "Jerusalem (limited recognition)"},
    {"name": "Italy", "capital": "Rome"},
    {"name": "Ivory Coast", "capital": "Yamoussoukro (political), Abidjan (economic)"},
    {"name": "Jamaica", "capital": "Kingston"},
    {"name": "Japan", "capital": "Tokyo"},
    {"name": "Jordan", "capital": "Amman"},
    {"name": "Kazakhstan", "capital": "Astana"},
    {"name": "Kenya", "capital": "Nairobi"},
    {"name": "Kiribati", "capital": "South Tarawa on Tarawa"},
    ...
    {
        "name": "Malaysia",
        "capital": "Putrajaya (administrative), Kuala Lumpur (ceremonial, legislative and judicial)",
    },
    {"name": "Mali", "capital": "Bamako"},
    {"name": "Malta", "capital": "Valletta"},
    {"name": "Marshall Islands", "capital": "Delap-Uliga-Djarrit on Majuro"},
    ...
    {"name": "Monaco", "capital": "Monaco (city-state)"},
    ...
    {"name": "Nauru", "capital": "None (de jure), Yaren (de facto)"},
    ...
    {"name": "State of Palestine", "capital": "Jerusalem"},
    ...
    {"name": "Philippines", "capital": "Manila (de jure)"},
    ...
    {"name": "Switzerland", "capital": "None (de jure), Bern (de facto)"},
    ...
    {"name": "Vatican City", "capital": None},
    ...
    {"name": "Niue", "capital": "Alofi"},
    {
        ...
        "capital": "El Aaiúna (de jure), Tifariti (de facto)",
    },
    {"name": "Canada", "capital": "Ottawa"},
    {"name": "Norway", "capital": "Oslo"},
    {"name": "France", "capital": "Paris"},
    {"name": "Kosovo", "capital": "Pristinaa"},
